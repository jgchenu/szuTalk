...
export default {
  ...
  config: {
    ...
    pages: ['pages/logs/main', 'pages/index/main', 'pages/me/main', 'pages/search/main', '^pages/detail/main', 'pages/main/main', 'pages/wallet/main', 'pages/comment/main', 'pages/task/main', 'pages/relTalk/main', 'pages/relTask/main'],
    window: {
